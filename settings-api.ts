...
export const DEFAULT_PARTNER_PAGES_CONTENT: PartnerPagesContent = {
  ...
  reseller_registration: {
    hero_heading: 'Saree Dropshipping & Reseller Registration',
    hero_subtext:
      'Start a saree dropshipping business in India with zero investment. Register free, set your own markup, and sell our handloom collection under your name — we hold the stock and ship every order directly to your customer.',
    cta_label: 'Start Dropshipping — Register Free',
    steps: [
      { title: 'Create a free account', body: 'Sign up or log in with your existing AruhiHandlooms account — no separate dropshipping signup needed.' },
      { title: 'Join the dropshipping program', body: 'One click from your account to join as a reseller/dropshipper — no application review, no waiting period.' },
      { title: 'Share products, zero inventory', body: 'Share our handloom catalog with your customers on WhatsApp, Instagram, or your own store. We hold all stock — you never buy or store inventory.' },
      { title: 'Set your markup, we ship direct', body: 'Choose your own markup on top of our price. When an order comes in, we pack and ship it straight to your customer — you just collect your profit.' },
    ],
    faqs: [
      { q: 'How do I start a saree dropshipping business on AruhiHandlooms?', a: 'Log in or create a free AruhiHandlooms account, then join the reseller/dropshipping program from your account page in a single click — there is no separate application form and no upfront investment.' },
      { q: 'Is dropshipping registration free?', a: 'Yes, joining the dropshipping/reseller program is free and there is no inventory to buy upfront. You only pay our price once a customer has already paid you.' },
      { q: 'How much can I earn dropshipping sarees?', a: 'You set your own markup amount on top of our base price. You earn that markup on every order placed through your reseller link, with no stock or shipping to manage yourself.' },
    ],
  },
  reseller_login: {
