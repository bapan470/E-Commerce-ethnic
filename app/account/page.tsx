    ...
    <div className="space-y-6">
      ...
      <div className="rounded-xl bg-primary/5 px-4 py-5 border border-primary/10">
        ...
        <div className="mt-4 grid grid-cols-2 gap-3">
          <Link
            href="/account/orders"
            className="rounded-lg bg-background border border-border/60 px-3 py-3 text-center hover:border-primary/30 transition-colors"
          >
            <p className="font-serif text-2xl font-bold text-primary">{orderCount ?? 0}</p>
          ...
          <Link
            ...
            className="rounded-lg bg-background border border-border/60 px-3 py-3 text-center hover:border-primary/30 transition-colors"
          >
            <p className="font-serif text-2xl font-bold text-primary">{loyaltyBalance}</p>
            <p className="text-xs text-muted-foreground mt-0.5">Reward Points</p>
          </Link>
        </div>
      </div>
