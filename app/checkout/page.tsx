...
import { Lock, Loader2, CreditCard, Tag, X, Wallet, Sparkles, Gift, Store, Minus, Plus, ChevronRight, BadgePercent } from 'lucide-react';
import {
  useCart,
  usePaymentDiscount,
  computeBogoDiscount,
...
export default function CheckoutPage() {
  ...
  return (
    <div className="container-boutique py-8">
      ...
      {!appliedCoupon && (paymentDiscount.enabled && potentialOnlinePaymentDiscount > 0 || availableCoupons.length > 0) && (
